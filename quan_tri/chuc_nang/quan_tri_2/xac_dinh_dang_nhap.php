...
{
    $lien_ket_trang_truoc = $_SERVER['HTTP_REFERER']; //  $_SERVER['HTTP_REFERER'] dùng để lấy url trang trước
?>
    <html>

    <head>
        <meta charset="UTF-8">
        <title>Xác định đăng nhập</title>
    </head>
...
if (isset($_POST['dang_nhap_quan_tri'])) {
    ...
    $tv_1 = $tv->query("select count(*) from thong_tin_quan_tri where ky_danh='$ky_danh' and mat_khau='$mat_khau' ");
